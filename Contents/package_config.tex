...
\lstdefinelanguage{Solidity}{
  backgroundcolor=\color{lightgray},
  keywords={pragma, mapping, modifier, contract, function, return, constructor, public, private, external, internal, payable, view, pure, event, emit},
  ...
  tabsize=2,
  frame=single,
  morekeywords=[2]{address, uint, string, bool, mapping, struct, require, keccak256},
  keywordstyle=[2]\color{green}\bfseries,
  morekeywords=[3]{isUserRegistered, registerUser, unregisterUser},
